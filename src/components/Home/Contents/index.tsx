    ...
    if (window.ethereum) {
      ...
      try {
        ...
        window.ethereum.enable().then((res: any) => {
          ...
          message.success('successfu lconnection!')
        }).catch((err: any) => {
          console.log(err);
        })
      } catch (error) {
          ...
          <Skeleton loading={this.state.loading} active paragraph={{ rows: 15 }} >
            ...
            <div className='contents-claim mb-20px'>
              ...
              <div>
                ...
                <Button type="primary" className='mt-20px' onClick={this.preview}>Invite</Button>
              </div>
             </div>
